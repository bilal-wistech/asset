...
class Helper
{
    ...
    */
    ...
    public static function getClaimableLabel()
    {
        return [
            '1' => '<label class="label label-default label-success">Yes</label>',
            '0' => '<label class="label label-default label-alert">No</label>',
        ];
    }
