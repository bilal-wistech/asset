            ...
            <div class="box box-default">
                <div class="box-body">
                    <div class="table-responsive">
                        <div class="table-responsive">
                            <table data-cookie-id-table="SalaryTable" data-pagination="true"
                                data-id-table="SalaryTable" data-search="true" data-side-pagination="server"
                                data-show-columns="true" data-show-fullscreen="true" data-show-export="true"
                                data-show-refresh="true" data-sort-order="asc" id="SalaryTable"
                                ...
                                <thead>
                                    <tr>
                                        <th data-sortable="true" data-field="id" data-visible="false">
                                            {{ trans('ID') }}</th>
                                        <th data-sortable="true" data-field="riding_company" data-visible="true">
                                            {{ trans('Riding Company') }}</th>
                                        <th data-sortable="true" data-field="driver" data-visible="true">
                                            {{ trans('Driver') }}</th>
                                        <th data-sortable="true" data-field="amount_paid" data-visible="true">
                                        ...
                                        <th data-sortable="true" data-field="to_date" data-visible="true">
                                            {{ trans('To Date') }}</th>
                                            <th data-sortable="true" data-field="to_date" data-visible="false">
                                                {{ trans('Created By') }}</th>
