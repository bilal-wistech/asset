            ...
            return function(value, row) {
                ...
                if ((row.available_actions) && (row.available_actions.delete === true)) {
                    ...
                    if (dest == 'insurance') {
                        ...
                        actions += '<a href="' +
                            '{{ route('insurance.delete', ['insurance_id' => 'REPLACE_ID']) }}'.replace('REPLACE_ID',
                                row.id) + '" ' +
                        ...
                        actions += '<a href="' + '{{ route('fines.del', ['id' => 'REPLACE_ID']) }}'.replace(
                                'REPLACE_ID', row.id) + '" ' +
                            ' class="actions btn btn-danger btn-sm" data-tooltip="true" ' +
                            ' data-title="{{ trans('general.delete') }}" onClick="return confirm(\'Are you sure you want to delete this record?\');">' +
                            '<i class="fas fa-trash" aria-hidden="true"></i><span class="sr-only">{{ trans('general.delete') }}</span></a>&nbsp;';
                        ...
                        actions += '<a href="' + '{{ route('accidents.del', ['id' => 'REPLACE_ID']) }}'.replace(
                                'REPLACE_ID', row.id) + '" ' +
                            ' class="actions btn btn-danger btn-sm" data-tooltip="true" ' +
                            ' data-title="{{ trans('general.delete') }}" onClick="return confirm(\'Are you sure you want to delete this record?\');">' +
                            '<i class="fas fa-trash" aria-hidden="true"></i><span class="sr-only">{{ trans('general.delete') }}</span></a>&nbsp;';
                    ...
                    } else if (dest == 'deduction') {

                        actions += '<a href="' + '{{ route('deductions.delete', ['id' => 'REPLACE_ID']) }}'.replace(
                                'REPLACE_ID', row.id) + '" ' +
                            ' class="actions btn btn-danger btn-sm" data-tooltip="true" ' +
                            ' data-title="{{ trans('general.delete') }}" onClick="return confirm(\'Are you sure you want to delete this record?\');">' +
                            '<i class="fas fa-trash" aria-hidden="true"></i><span class="sr-only">{{ trans('general.delete') }}</span></a>&nbsp;';
                        ...
                        actions += '<a href="' + '{{ route('receipts.delete', ['id' => 'REPLACE_ID']) }}'.replace(
                                'REPLACE_ID', row.id) + '" ' +
                            ' class="actions btn btn-danger btn-sm" data-tooltip="true" ' +
                            ' data-title="{{ trans('general.delete') }}" onClick="return confirm(\'Are you sure you want to delete this record?\');">' +
                            '<i class="fas fa-trash" aria-hidden="true"></i><span class="sr-only">{{ trans('general.delete') }}</span></a>&nbsp;';
