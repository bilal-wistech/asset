...
@section('inputFields')
    ...
    <div class="form-group ">
        ...
        <div class="col-md-6 col-sm-12">
            ...
            @if ($errors->has('error'))
            <span class="alert-msg" aria-hidden="true"><i class="fas fa-times mt-2" aria-hidden="true"></i> {{ $errors->first('error') }}</span>
            @endif
        </div>
    ...
    <div class="form-group {{ $errors->has('accident_minimum_payment') ? ' has-error' : '' }}">
        <label for="accident_minimum_payment" class="col-md-3 control-label">Accident Minimum Payment</label>
        <div class="col-md-7">
            <div class="col-md-7" style="padding-left:0px">
                {{ Form::text('accident_minimum_payment', $item->accident_minimum_payment, ['class' => 'form-control', 'placeholder' => 'Enter driver cost', 'required']) }}
            </div>
        </div>
    </div>
