...
Route::group(['middleware' => ['api', 'throttle:api']], function () {
    ...
    Route::get(
        '/tsrepairoptions/index',
        [Api\RepairOptionsController::class, 'ShowRepairOptions']
    )->name('api.repairoptions.index');
});
...
Route::group(['prefix' => 'v1', 'middleware' => ['api', 'throttle:api']], function () {
    ...
    Route::get(
        '/deductions',
        [
            Api\DeductionController::class,
            'index'
        ]
    )->name('api.deduction.index');
    ...
    Route::get(
        '/cash-handover',
        [
            Api\CashHandoverController::class,
            'index'
        ]
    )->name('api.cash-handover.index');
    ...
    Route::post(
        '/vendor_create',
        [Api\SuppliersController::class, 'vendor_create']
    )->name('api.vendor.create')->middleware('auth:api');
}); // end API routes
Route::post('/accident-type', [AccidentController::class, 'accidentType'])->name('api.accident_type');
Route::post('/deduction-type', [DeductionController::class, 'deductionType'])->name('api.deduction_type');
